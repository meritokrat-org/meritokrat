...
//session_start();
$tinybrowser['sessioncheck'] = 'user_id'; //name of session variable to check
...
$tinybrowser['path']['image'] = '/uploads/tinymce/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/uploads/tinymce/'; // Media files location
$tinybrowser['path']['file']  = '/uploads/tinymce/'; // Other files location
...
$tinybrowser['filetype']['image'] = '*.jpeg, *.gif, *.png, *.jpg'; // Image file types
