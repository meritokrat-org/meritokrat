...
<? } else { ?>
<form rel="<?=t('Выберите друзей из списка')?>" id="share_form" action="/invites" method="post" onsubmit="return Application.doInvite();">
    ...
    <div class="m10 fs11 aleft" style="width: 550px;">
        ...
        <div class="left">
            <div id="friends_checker">
                ...
                <textarea name="message" style="height: 50px; width: 200px;"><?=$message?></textarea>
