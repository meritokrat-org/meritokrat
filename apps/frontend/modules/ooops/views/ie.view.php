...
<html> 
	<head> 
	  <title>Заголовок страницы</title>  
	  	...
	  	<link rel="shortcut icon" type="image/ico" href="/static/images/ie/favicon.ico" />
	  	<link rel="stylesheet" type="text/css" media="all" href="/static/css/old.css" />
	</head> 
			...
			<ul id="modern-browser"> 
				<li class="ie8"> 
					...
					<div class="descriptiontext">
						...
						<ul class="file"> 
							...
							<li class="habr"><a href="http://habrahabr.ru/special/ie8/">Internet Explorer 8 с сервисами habrahabr.ru, 16.4 Mb</a></li> 
						</ul> 
					</div> 
				</li>
				...
				<li class="chrome"> 
					...
					<div class="descriptiontext"> 
						...
						<ul class="file"> 
							<li><a href="http://www.google.com/chrome">Google Chrome, 556 Kb</a></li> 
						</ul> 
					</div> 
				</li>
