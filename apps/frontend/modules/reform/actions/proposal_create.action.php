...
class ppo_proposal_create_action extends ppo_controller
{
	...
	public function execute()
	{
		...
		{
			$id = ppo_proposal_peer::instance()->insert(array(
			...
			ppo_proposal_messages_peer::instance()->insert(array(
				'topic_id' => $id,
		...
		$this->redirect('/ppo/proposal_topic?id='.$id);
	}
}