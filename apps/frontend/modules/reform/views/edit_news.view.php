...
<form id="edit_form" method="post" class="form form_bg mt10">
	...
	<table width="100%" class="fs12">
		<tr>
			...
			<td><input value="<?= $post_data['title'] ?>" rel="<?= t('Введите заголовок новости') ?>"
			           style="width: 350px;" name="title" type="text" class="text"/></td>
		</tr>
...
<form id="upload_form" class="hide form" action="/profile/upload" enctype="multipart/form-data"
