...
<form rel="<?= t('Выберите пользователя') ?>" id="share_form" action="/team/showusers" method="post">
	<input type="hidden" name="act" id="act"/>
	<input type="hidden" name="team_id" id="team_id" value="<?= request::get_int('team_id') ?>"/>
	...
	<div class="m10 fs11 aleft" style="width: 550px;">
		...
		<div class="friend_selector" id="user_selector">
			...
			<div class="clear"></div>
			<div id="user_pager" class="mt10 mb5 ml5 left pager"><?= pager_helper::get_full_ajax($userpager, null, 12, 18, $q, 0, 1) ?></div>
