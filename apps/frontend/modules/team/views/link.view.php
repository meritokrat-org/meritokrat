...
<? if ( (ppo_members_peer::instance()->is_member($group['id'], session::get_user_id()) ) or session::has_credential('admin')) { ?>
	<div class="form_bg mr10 fs12 p10 mb10">
		<div class="left">
			<? if ( $dir_id !== null ) { ?>
				<a href="/ppo/link?id=<?=$group['id']?>"><?=t('Ссылки сообщества')?></a> &rarr;
...
<? if (ppo_peer::instance()->is_moderator($group['id'], session::get_user_id()) and $dir_id!=0)   { ?>
                        <div class="left mt15 ml15"><a class="fs10" onclick="return confirm('Ви впевнені?');" href="/ppo/linkdir_delete?id=<?=$dir_id?>">[X]</a></div>
                    <? } ?>
            <div class="clear"></div>
