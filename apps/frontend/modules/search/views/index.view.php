...
<div class="form_bg mt10 mr10 mb15" id="all_content">
    ...
    <a onclick="$('#searchformcontainer').show()" class="srchpanel fs11 ml15 mt5 <?= (request::get_int(
                    'status'
            ) || request::get_int('segment') || request::get_int('expert') || request::get_string(
                    'gender'
            ) || request::get_int('contacts') || request::get_int('offline')) || request::get_int(
            'map'
    ) || request::get_int('smap') ? '' : 'bold' ?>" href="javascript:;" rel="search">
        <?= t('Основной') ?>
    </a> <a onclick="$('#searchformcontainer').show()" class="srchpanel fs11 ml15 mt5 <?= ((request::get_int(
                            'status'
                    ) || request::get_int('segment') || request::get_int('expert') || request::get_string(
                            'gender'
                    ) || request::get_int('offline')) && !request::get_int('contacts')) && !request::get_int(
            'map'
    ) && !request::get_int('map') ? 'bold' : '' ?>" href="javascript:;" rel="search_advanced">
        <?= t('Расширенный') ?>
    </a>
    <?php if (session::is_authenticated()) { ?>
        <a onclick="$('#searchformcontainer').show()" class="<?= (request::get_int(
                'map'
        )) ? 'srchpanel' : '' ?> fs11 ml15 mt5 <?= (request::get_int(
                'map'
        )) ? 'bold' : '' ?>" href="<?= (!request::get_int(
                'map'
        )) ? '/search?map=1&distance=10&submit=1' : 'javascript:;' ?>" <?= (request::get_int(
                'map'
        )) ? 'rel="search_map"' : '' ?>>
            <?= t('Кто рядом') ?>
        </a>

        <a class="<?= (request::get_int('smap')) ? 'srchpanel' : '' ?> fs11 ml15 mt5 <?= (request::get_int(
                'smap'
        )) ? 'bold' : '' ?>" href="<?= (!request::get_int(
                'smap'
        )) ? '/search?smap=1&distance=10&submit=1' : 'javascript:;' ?>" <?= (request::get_int(
                'smap'
        )) ? 'rel="search_smap"' : '' ?>>
            <?= t('Карта') ?> <?= db::get_scalar(
...
AND user_auth.active=true WHERE locationlng>0"
            ...
            +<?= db::get_scalar("SELECT count(*) FROM user_data WHERE onmap=0 AND locationlng>0") ?>) </a>
    <?php } ?>
    <?php if (session::has_credential('admin') || count($is_regional_coordinator) > 0 || count(
                    $is_raion_coordinator
            ) > 0) { ?>
        <a onclick="$('#searchformcontainer').show()" class="srchpanel fs11 ml15 mt5 <?= (request::get_int(
                'contacts'
        )) ? 'bold' : '' ?>" href="javascript:;" rel="search_contacts"> *<?= t('Контакты') ?>
        </a>
    <?php } ?>
    <?php if ($found) { ?>
        <a class="right fs11 mr10" href="javascript:;" onclick="$('#searchformcontainer').toggle()" rel="search_contacts">
            <?= t('Показать/спрятать форму') ?>
        </a>
    <?php } ?>

    <div id="searchformcontainer" class="<?= ($found && (!request::get_int('map') || (request::get_int(
                                    'map'
                            ) && request::get_int('page')))) ? 'hide' : '' ?>">
        <!-- SIMPLE -->
        <div id="search" class="mt10 fs11 <?= (request::get_int('status') || request::get_int(
                        'segment'
                ) || request::get_int('expert') || request::get_string('gender') || request::get_int(
                        'contacts'
                ) || request::get_int('offline') || request::get_int('map') || request::get_int(
                        'smap'
                )) ? 'hide' : '' ?>">
            <form method="get" action="/search" class="mr10 ml10">
                <table>
                    <tr>
                        ...
                        <td>
                            <input name="first_name" style="width:194px;" class="text" type="text" value="<?= stripslashes(
                                    htmlspecialchars(request::get_string('first_name'))
                            ) ?>"/>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input name="last_name" style="width:194px;" class="text" type="text" value="<?= stripslashes(
                                    htmlspecialchars(request::get_string('last_name'))
                            ) ?>"/>
                        </td>
                    </tr>
                    <?php if (session::has_credential('admin')) { ?>
                        <tr>
                            ...
                            <td>
                                <input name="email" style="width:194px;" class="text" type="text" value="<?= stripslashes(
                                        htmlspecialchars(request::get_string('email'))
                                ) ?>"/>
                            </td>
                        </tr>
                    <?php } ?>
                    <tr>
                        ...
                        <td>
                            <?php load::model('geo') ?><?php $сountries = geo_peer::instance()->get_countries(); ?>
                            <?= tag_helper::select(
                                    'country',
                                    $сountries,
                                    [
                                            'use_values' => false,
                                            'style'      => 'width:200px;',
                                            'value'      => request::get_int('country', 0),
                                            'id'         => 'country',
                                            'rel'        => t('Выберите страну'),
                                            /*'onchange'=>"getRegions(this,'info','region','/ua/ajax/action/regions/')"*/
                                    ]
                            ) ?>
                        </td>
                    </tr>
                    <tr id="region_row">
                        ...
                        <td>
                            ...
                            ?>
                            <input name='region_txt' type='text' style="display: none" id='region_txt' value="<?= request::get_string(
                                    "region_txt",
                                    ""
                            ) ?>">
                            <?= tag_helper::select(
                                    ...
                                    [
                                            'use_values' => false,
                                            'style'      => "width:160px; ".$style_sel,
                                            'value'      => request::get_int('region', 0),
                                            'id'         => 'region',
                                            'name'       => 'region',
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
                            $cities[0] = "&mdash;";
                            $cities    += geo_peer::instance()->get_cities(
                                    request::get_int('region', 1),
                                    request::get_int("country", 1) > 1 ? true : false
                            );
                            ?>
                            <input name='city_txt' type='text' style="display: none" id='city_txt' value="<?= request::get_string(
                                    "city_txt",
                                    ""
                            ) ?>">
                            <?= tag_helper::select(
                                    ...
                                    [
                                            'use_values' => false,
                                            'value'      => request::get_int('city', 0),
                                            'style'      => "width:160px; ".$cstyle_sel,
                                            'id'         => 'city',
                                            'name'       => 'city',
                    ...
                    <tr>
                        ...
                        <td><?= tag_helper::select(
                                    ...
                                    [
                                            'use_values' => false,
                                            'value'      => request::get_int('function'),
                                            'style'      => 'width:200px;',
                                    ]
                            ) ?></td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <select name="status">
                                ...
                                <?php $sts = user_auth_peer::get_statuses() ?>
                                <?php if (session::has_credential('admin')) {
                                    $sts[99] = '*'.t('Лише мерітократи');
                                } ?>
                                <?php foreach ($sts as $k => $v) { ?>
                                    <option value="<?= $k ?>" <?= (request::get(
                                                    'status'
                                            ) === "$k") ? 'selected="selected"' : '' ?>><?= $v ?></option>
                                <?php } ?>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <select name="visit_ts" value="" use_values="">
                                <option value="" <?= request::get(
                                        'visit_ts'
                                ) == '' ? 'selected' : '' ?>>&mdash;
                                </option>
                                <option value="1" <?= request::get('visit_ts') == 1 ? 'selected' : '' ?>><?= t(
                                            'сегодня'
                                    ) ?></option>
                                <option value="3" <?= request::get('visit_ts') == 3 ? 'selected' : '' ?>><?= t(
                                            '3 дня'
                                    ) ?></option>
                                <option value="7" <?= request::get('visit_ts') == 7 ? 'selected' : '' ?>><?= t(
                                            'неделя'
                                    ) ?></option>
                                <option value="30" <?= request::get('visit_ts') == 30 ? 'selected' : '' ?>><?= t(
                                            'месяц'
                                    ) ?></option>
                                <option value="-7" <?= request::get('visit_ts') == '-7' ? 'selected' : '' ?>><?= t(
                                            'больше недели'
                                ...
                                <option value="-163" <?= request::get('visit_ts') == '163' ? 'selected' : '' ?>><?= t(
                                            'больше полгода'
                                    ) ?></option>
                                <option value="-365" <?= request::get('visit_ts') == '-365' ? 'selected' : '' ?>><?= t(
                                            'больше года'
                                    ) ?></option>
                    ...
                    <?php if (session::has_credential('admin') || user_desktop_peer::instance(
                            )->is_regional_coordinator(session::get_user_id()) || user_desktop_peer::instance(
                            )->is_raion_coordinator(session::get_user_id())) { ?>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (request::get_int('start_begin_day') && request::get_int(
                                                'start_begin_month'
                                        ) && request::get_int('start_begin_year')) {
                                    $start_begin = mktime(
                                            0,
                                            0,
                                            0,
                                            request::get_int('start_begin_month'),
                                            request::get_int('start_begin_day'),
                                            request::get_int('start_begin_year')
                                    );
                                } ?>
                                <?= user_helper::datefields('start_begin', intval($start_begin), false, [], true) ?>
                                <span class="left mr10">&mdash;</span>
                                <?php if (request::get_int('start_end_day') && request::get_int(
                                                'start_end_month'
                                        ) && request::get_int('start_end_year')) {
                                    $start_end = mktime(
                                            0,
                                            0,
                                            0,
                                            request::get_int('start_end_month'),
                                            request::get_int('start_end_day'),
                                            request::get_int('start_end_year')
                                    );
                                } ?>
                                <?= user_helper::datefields('start_end', intval($start_end), false, [], true) ?>
                            </td>
                        </tr>
                        <tr>
                            <td class="aright">* <?= t('Активация профиля') ?></td>
                            <td>
                                <?php if (request::get_int('activation_begin_day') && request::get_int(
                                                'activation_begin_month'
                                        ) && request::get_int('activation_begin_year')) {
                                    $activation_begin = mktime(
                                            0,
                                            0,
                                            0,
                                            request::get_int('activation_begin_month'),
                                            request::get_int('activation_begin_day'),
                                            request::get_int('activation_begin_year')
                                    );
                                } ?>
                                <?= user_helper::datefields(
                                        'activation_begin',
                                        intval($activation_begin),
                                        false,
                                        [],
                                        true
                                ) ?>
                                <span class="left mr10">&mdash;</span>
                                <?php if (request::get_int('activation_end_day') && request::get_int(
                                                'activation_end_month'
                                        ) && request::get_int('activation_end_year')) {
                                    $activation_end = mktime(
                                            0,
                                            0,
                                            0,
                                            request::get_int('activation_end_month'),
                                            request::get_int('activation_end_day'),
                                            request::get_int('activation_end_year')
                                    );
                                } ?>
                                <?= user_helper::datefields(
                                        'activation_end',
                                        intval($activation_end),
                                        false,
                                        [],
                                        true
                                ) ?>
                    ...
                    if (session::has_credential('admin')) { ?>
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" value="1" name="interesting" <?= request::get(
                                        'interesting'
                                ) ? 'checked="checked"' : '' ?>> Цікава особа
                            </td>
                        </tr>
                        <tr>
                            <td class="aright">* Про себе</td>
                            <td>
                                <input type="radio" value="1" name="about" <?= request::get(
                                        'about'
                                ) == 1 ? 'checked="checked"' : '' ?>> заповнено
                                <input type="radio" value="2" name="about" <?= request::get(
                                        'about'
                                ) == 2 ? 'checked="checked"' : '' ?>> не заповнено
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><?= tag_helper::select(
                                        ...
                                        [
                                                'use_values' => false,
                                                'value'      => request::get_int('contacted'),
                                                'style'      => 'width:200px;',
                                        ]
                                ) ?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="contact_status">
                                    <option value="">&mdash;</option>
                                    <?php foreach (user_helper::get_statuses() as $k => $v) { ?>
                                        <option value="<?= $k ?>" <?= (request::get(
                                                        'contact_status'
                                                ) === "$k") ? 'selected="selected"' : '' ?>><?= $v ?></option>
                                    <?php } ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="target">
                                    <option value="">&mdash;</option>
                                    <?php foreach (user_helper::get_targets() as $k => $v) { ?>
                                        <option value="<?= $k ?>" <?= (request::get(
                                                        'target'
                                                ) === "$k") ? 'selected="selected"' : '' ?>><?= $v ?></option>
                                    <?php } ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" value="1" name="outlook" <?= request::get(
                                        'outlook'
                                ) ? 'checked="checked"' : '' ?>> Outlook
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="sort" value="" use_values="">
                                    <option value="az" <?= request::get(
                                            'sort'
                                    ) == 'az' ? 'selected' : '' ?>>За прізвищем
                                    </option>
                                    <option value="last" <?= (request::get('sort') == 'last' or !request::get(
                                                    'sort'
                                            )) ? 'selected' : '' ?>>
                                        Останні першими
                                    </option>
        ...
        <div id="search_advanced" class="mt10 fs11 <?= ((request::get_int('status') || request::get_int(
                                'segment'
                        ) || request::get_int('expert') || request::get_string('gender') || request::get_int(
                                'offline'
                        )) && (!request::get_int('contacts'))) ? '' : 'hide' ?>">
            <form method="get" action="/search" class="mr10 ml10">
                <table>
                    <tr>
                        <td class="aright" width="250"><?= t('Имя') ?></td>
                    ...
                    <?php if (session::has_credential('admin')) { ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="phone" style="width:194px;" class="text" type="text" value="<?= stripslashes(
                                        htmlspecialchars(request::get_string('phone'))
                                ) ?>"/>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <?= tag_helper::select(
                                        ...
                                        [
                                                'use_values' => false,
                                                'style'      => 'width:200px;',
                                                'value'      => request::get_int('has_phone'),
                                                'id'         => 'has_phone',
                                        ]
                                ) ?>
                            </td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?= tag_helper::select(
                                    'age_start',
                                    $ages,
                                    ['use_values' => true, 'style' => 'width:91px;', 'value' => $age_start]
                            ) ?>
                            &mdash;
                            <?= tag_helper::select(
                                    'age_end',
                                    $ages,
                                    ['use_values' => true, 'style' => 'width:91px;', 'value' => $age_end]
                            ) ?>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <?= tag_helper::select(
                                    ...
                                    [
                                            'use_values' => false,
                                            'style'      => 'width:200px;',
                                            'value'      => request::get_int('country', 1),
                                            'id'         => 'country',
                                            'rel'        => t('Выберите страну'),
                                            /*'onchange'=>"getRegions(this,'info','region','/ua/ajax/action/regions/')"*/
                                    ]
                    ...
                    <tr id="region_row">
                        <td class="aright"><?= t('Регион') ?></td>
                        <td>
                            <?php if (request::get_int('country', 0) < 2) {
                                $regions     = geo_peer::instance()->get_regions(request::get_int('country', 1));
                                $regions[''] = '&mdash;';
                                ksort($regions);
                            } else {
            ...
            <td><?=tag_helper::select('expert', $expert, array('use_values' => false, 'value' => request::get_int('expert'),'style'=>'width:200px;'))?></td>
                    ...
                    */
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" value="1" name="work_jobsearch1" <?= request::get(
                                    'work_jobsearch1'
                            ) == 1 ? 'checked="checked"' : '' ?> /> <?= t('Активно ищу работу') ?>
                            <br/> <input type="checkbox" value="2" name="work_jobsearch2" <?= request::get(
                                    'work_jobsearch2'
                            ) == 2 ? 'checked="checked"' : '' ?> /> <?= t('Работаю, но открыт для предложений') ?>
                        </td>
                    </tr>
                    <tr>
                        <td class="aright"><?= t('Последнее посещение') ?></td>
                    ...
                    if (session::has_credential('admin')) { ?>
                        <tr>
                            <td class="aright">* Мітки</td>
                            <td><input type="checkbox" value="1" name="interesting" <?= request::get(
                                        'interesting'
                                ) ? 'checked="checked"' : '' ?>> Цікава особа
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="offline" value="" use_values="">
                                    <option value="1" <?= request::get_int(
                                            'offline'
                                    ) == 1 ? 'selected' : '' ?>>&mdash;
                                    </option>
                                    <option value="2" <?= (request::get_int('offline') == 2 or !request::get_int(
                                                    'offline'
                                            )) ? 'selected' : '' ?>><?= t('Он-лайн') ?></option>
                                    <option value="3" <?= request::get_int('offline') == 3 ? 'selected' : '' ?>><?= t(
                                                'Офф-лайн'
                                        ) ?></option>
                                </select>
                            </td>
                    ...
                    <?php if (session::has_credential('admin')) { ?>
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" <?= request::get(
                                        'suslik'
                                ) == 1 ? 'checked' : '' ?> name="suslik" value="1"/>
                            </td>
                        </tr>
                        <tr>
                ...
                <table class="m0" style="margin-left: 85px;">
                    <tr>
                        <td class="aright pt5" style="padding-right: 0; padding-top: 7px;"><b><?= t('В радиусе') ?>
                                (км)</b></td>
                        <td class="aleft">
                            <input type="text" class="text" value="<?= (request::get_int(
                                    'distance'
                            )) ? request::get_int('distance') : '100' ?>" id="distance" name="distance" size="10">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td id="region_contact_col">
                                <select id="region_contact_city_select" name="region_contact_city_select" style="width: 200px;">
                                    <option value="">&mdash;
                                    <option>
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="description" style="width:194px;" class="text" type="text" value="<?= stripslashes(
                                        htmlspecialchars(request::get_string('description'))
                                ) ?>"/>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input name="contact_user_id" style="width:194px;" class="text" type="text" value="<?= stripslashes(
                                        htmlspecialchars(request::get_int('contact_user_id'))
                                ) ?>"/>
                            </td>
                        </tr>
                        <tr>
                            <td class="aright"><?= t('Кто') ?></td>
                            <td> <?php $who_contacts = user_novasys_data_peer::get_who_contacts();
                                $who_contacts['']    = '&mdash;';
                                ksort($who_contacts);
                                ?>
                                <?= tag_helper::select(
                                        'contact_who',
                                        $who_contacts,
                                        ['use_values' => false, 'value' => request::get_int('contact_who')]
                                ) ?>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <?= tag_helper::select(
                                        'contact_type',
                                        user_helper::get_contact_types(),
                                        ['use_values' => false, 'value' => request::get_int('contact_type')]
                                ) ?>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <?php if (request::get_int('period_begin_day') && request::get_int(
                                                'period_begin_month'
                                        ) && request::get_int('period_begin_year')) {
                                    $period_begin = mktime(
                                            0,
                                            0,
                                            0,
                                            request::get_int('period_begin_month'),
                                            request::get_int('period_begin_day'),
                                            request::get_int('period_begin_year')
                                    );
                                } ?>
                                <?= user_helper::datefields('period_begin', intval($period_begin), false, [], true) ?>
                                <span class="left mr10">&mdash;</span>
                                <?php if (request::get_int('period_end_day') && request::get_int(
                                                'period_end_month'
                                        ) && request::get_int('period_end_year')) {
                                    $period_end = mktime(
                                            0,
                                            0,
                                            0,
                                            request::get_int('period_end_month'),
                                            request::get_int('period_end_day'),
                                            request::get_int('period_end_year')
                                    );
                                } ?>
                                <?= user_helper::datefields('period_end', intval($period_end), false, [], true) ?>
                            </td>
                        </tr>
                        <tr>
                            <td class="aright"></td>
    ...
    <?php if ($count_found > 0) { ?>
        <table class="fs11 mt15">
            <tr>
                ...
                <td>
                    <b><?= $count_found ?></b> <?php //=($count_found>=500)?'('.t('Поиск ограничен по количеству результатов, введите более точные условия').')':''?>
                    <?php if (session::has_credential('admin') || (in_array(
                                    request::get('region'),
                                    $is_regional_coordinator
                            )) || (in_array(request::get('city'), $is_raion_coordinator))) { ?>
...
<div id="search_form_holder" class="hide">
    <table class="srch fs12">
            ...
            <tr>
                ...
                <td class="aleft">
                    <?php if (request::get_int('contacts')) { ?>
                        <input type="checkbox" name="cd" value="1" checked="checked"/><?= t(
                                'Ограничить по дате контакта'
                        ) ?><?php } else { ?>
                        <input type="checkbox" name="rf" value="1"/><?= t('Как попал в Меритократ') ?><?php } ?>
                </td>
            </tr>
            <tr>
                <td class="aleft"><input type="checkbox" name="pc" value="1"/><?= t('Профиль создан ...') ?></td>
                <td class="aleft"><?php if (request::get_int('contacts')) { ?>
                        <input type="checkbox" name="cn" value="1" checked="checked"/><?= t(
                                'Содержание контакта'
                        ) ?><?php } ?>
                </td>
            </tr>
        ...
        <tr>
            ...
            <td class="aleft"><input type="checkbox" name="all_pages" value="1"/><b><?= t(
        ...
        <tr>
            <td colspan="2" style="text-align:center">
                ...
                <input type="button" class="button_gray" id="print_off" value="<?= t(
                        'Назад'
                ) ?>" onclick="printoff();"/>
            </td>
        </tr>
...
<div id="search_smap" class="mt10 fs11 <?= (request::get_int('smap')) ? '' : 'hide' ?>">
    <?php if (request::get_int('smap')) {
        include 'partials/map.php';
    } ?>
</div>

<div class="mr10">
    <?php if ($found && request::get_int('outlook')) { ?>
        <div style="width:200px; font-size: 90%;" class="ml10 left mr10">
            <?php foreach ($users as $id) { ?><?php include 'partials/outlook.php' ?><?php } ?>
        </div>
    ...
    <?php if ((context::get_controller()->get_module() == "search") && (session::has_credential('admin'))) { ?>
        <script src="/static/javascript/jquery/jquery-1.10.2.js"></script>
        <script src="/static/javascript/jquery/jquery-ui-1.11.4.js"></script>    <?php } ?>
        ...
        <div class="left ml10">
            ...
            <div class="mb10" style="-moz-border-radius: 4px 4px 4px 4px; border:solid 1px #660000; float:left; padding-top:10px">
                <ul class="search-results connectedSortable" id="results-all" style="width: 100%;">
                    <?php foreach ($users as $id) { ?>
                        <li class="mb10 ml10 sortable_li" data-user-id='<?= $id ?>' style="width: 450px" ui-parrent="results-all">
        ...
        <!--		<ul id="sort_list" class="sort" style="list-style: none; margin: 0">-->        <!--			--><?php //
    //			foreach ( $list as $id )
    //			{
    ...
    <?php } elseif (!request::get_int('smap')) { ?>
