...
<form rel="<?= t('Выберите пользователя') ?>" id="share_form" action="/groups/showusers" method="post">
	<input type="hidden" name="act" id="act"/>
	<input type="hidden" name="group_id" id="group_id" value="<?= request::get_int('group_id') ?>"/>
