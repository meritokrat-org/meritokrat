...
<div class="mb10 comment_bg mr10" id="talk_message<?=$id?>">
	...
	<div class="left acenter mt5" style="width: 80px;">
		...
		<div id="vote_pane">
			...
			<?  if ( session::is_authenticated() && !groups_topics_messages_peer::instance()->has_rated($topic_message['id'], session::get_user_id()) ) { ?>
					<a href="javascript:;" onclick="groupsController.rateMessage(this, <?=$topic_message['id']?>, true);"><?=tag_helper::image('common/up.gif', array('height' => 16, 'class' => 'vcenter'))?></a>
					<a href="javascript:;" onclick="groupsController.rateMessage(this, <?=$topic_message['id']?>, false);"><?=tag_helper::image('common/down.gif', array('height' => 16, 'class' => 'vcenter'))?></a>
			<? }  ?>
                </div>
	...
	<div class="left ml10" style="width: 660px;">
		...
		<? if ( ( $topic_message['user_id'] == session::get_user_id() ) || groups_peer::instance()->is_moderator($group['id'], session::get_user_id()) ) { ?>
			<div class="fs10 mt10">
                                ...
                                <a href="/groups/talk_message_edit?id=<?=$id?><?=$counter==1 ? '&tinymce=1' : ''?>" class="maroon dotted"><?=t('Редактировать')?></a>
                                
				<a href="javascript:;" onclick="groupsController.deleteTalkMessage(<?=$id?>);" class="ml10 maroon dotted"><?=t('Удалить')?></a>
