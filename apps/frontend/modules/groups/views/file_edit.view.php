...
<? if (request::get_int('dir_id')) {
    ...
    $dir = groups_files_dirs_peer::instance()->get_item(request::get_int('dir_id'));
    ?>
                    <form action="/groups/dir_edit" class="form" method="post">
...
<? } else {
    ...
    $file = groups_files_peer::instance()->get_item(request::get_int('id'))
            ?>
                    <form action="/groups/file_edit" class="form" method="post">
