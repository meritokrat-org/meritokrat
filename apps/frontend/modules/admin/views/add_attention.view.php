	<div class="form_bg mt10">
		<h1 class="column_head">Додати важливу інформацію</h1>
		...
		<form method="post" class="mt10" action="">
			<table width="100%" class="fs12">
					...
					<td>
                                            <input type="radio" value="false" name="hidden" checked> так
                                            <input type="radio" value="true" name="hidden"> ні
                                        </td>
				</tr>
				<tr>
					<td class="aright" width="10%"><?=t('Название')?></td>
					<td><input type="text" name="title" value="<?=$attention['anounces']?>"></td>
				</tr>
				<tr id="tr_anounces_ua">
					<td class="aright" width="10%"><?=t('Анонс')?><div class="fs11 quiet"></div></td>
					<td><textarea rel="<?=t('Введите анонс Вашей')?>" name="anounces" style="width: 600px; height:200px;"></textarea></td>
				</tr>
				<tr id="tr_text_ua">
					<td class="aright" width="10%">Зміст</td>
					<td><textarea rel="<?=t('Введите текст Вашей')?>" name="text" id="text" style="width: 600px; height:627px;"></textarea></td>
				</tr>
                                <!-- RUSSIAN VERSION -->
				<tr id="tr_anounces_ru" class="hide">
					<td class="aright" width="10%"><?=t('Анонс')?> rus<div class="fs11 quiet"></div></td>
					<td><textarea rel="<?=t('Введите анонс Вашей')?>" name="anounces_ru" id="anounces_ru" style="width: 600px; height:200px;"></textarea></td>
				</tr>
				<tr id="tr_text_ru" class="hide">
					<td class="aright" width="10%">Содержание rus</td>
					<td><textarea rel="<?=t('Введите текст Вашей')?>" name="text_ru" id="text_ru" style="width: 600px; height:627px;"></textarea></td>
				</tr>
