...
<div class="form_bg mt10">
    ...
    <h1 class="column_head"><a href="/admin/help"><?=t('Текстовые страницы')?></a> &rarr; <?=($info['id'])?t('Редактирование'):t('Новая страница')?></h1>
    ...
    <form id="ua_form" class="form mt10">
        ...
        <table width="100%" class="fs12 ml10">
            ...
            <tr>
                <td>
                    <b><?=t('Alias')?></b><br/>
                    <input class="ifull" name="alias" rel="<?=t('Введите alias')?>" class="text" type="text" value="<?=stripslashes(htmlspecialchars($info['alias']))?>" />
                </td>
            </tr>
            <tr>
                <td>
                    <b><?=t('Заголовок')?></b><br/>
                    <input class="ifull" name="title_ua" rel="<?=t('Введите заголовок')?>" class="text" type="text" value="<?=stripslashes(htmlspecialchars($info['title_ua']))?>" />
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td>
                    <b><?=t('Переглядають')?></b><br/>
                    <? $status=user_auth_peer::get_statuses();
                    $status[0]='Усі';
                    $status[100]='Адміни';
                    ksort($status);
                    ?>
                    <?=tag_helper::select('status', $status, array('value'=>(db_key::i()->get('text_min_status:'.$info['alias']))))?>
                </td>
            </tr>
	    <tr>
                <td>
                    <b><?=t('Публікувати у соц. мережах')?></b><br/>
     ...
     <form id="ru_form" class="form mt10 hidden">
        ...
        <table width="100%" class="fs12 ml10">
            ...
            <tr>
                <td>
                    <b><?=t('Заголовок')?></b><br/>
                    <input class="ifull" name="title_ru" rel="<?=t('Введите заголовок')?>" class="text" type="text" value="<?=stripslashes(htmlspecialchars($info['title_ru']))?>" />
                </td>
            </tr>
            <tr>
                <td>
