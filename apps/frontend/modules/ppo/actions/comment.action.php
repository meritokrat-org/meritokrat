...
class ppo_comment_action extends frontend_controller
{
				...
				admin_feed_peer::instance()->add(session::get_user_id(), admin_feed_peer::TYPE_BLOG_COMMENT, $text, $comment, request::get_string('why'), 1);
                        ...
                        else
                        {
                            ...
                            if(request::get('neg_msg')==1) {
                                ...
                                if(!db_key::i()->exists('negative_ppo_blog_comment:'.$this->id))
                                    db_key::i()->set('negative_ppo_blog_comment:'.$this->id, 1);
                            }
