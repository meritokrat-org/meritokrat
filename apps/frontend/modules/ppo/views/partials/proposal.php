<? $topic = ppo_proposal_peer::instance()->get_item($id) ?>
<div class="mb5 box_content p5 mr10" id="comment<?=$id?>">
	<div class="mb5 bold">
		<a href="/ppo/proposal_topic?id=<?=$id?>"><?=stripslashes(htmlspecialchars($topic['topic']))?></a>
	</div>
	...
	<div class="left ml10" style="width: 525px;">
		<div class="fs11 pb5">
			<div class="left">
				...
				<a class="ml10" href="/ppo/proposal_topic?id=<?=$id?>&last=1"><?=t('Смотреть')?> &rarr;</a>
			</div>
			<div class="clear"></div>
		</div>
	</div>
