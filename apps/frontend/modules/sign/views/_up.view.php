...
<h4 class="mt15 fs28 cbrown" style="text-decoration: none; margin-left: 160px;margin-bottom: 0px;"><?=t('Регистрация')?>:</h4>
<div class="left" style="width: 50%;margin-left: 5px;">
	...
	<div class="success hidden mr10 mt10">
		<h4><?=t('Поздравляем')?>!</h4>
		<?=t('Благодарим за регистрацию! Вскоре на указанный Вами email прийдет сообщение про подтверждение Вашей регистрации')?>
	</div>
	<form id="signup_form" method="post">
		<table class="fs12 mr10 mt5">
			...
			<tr>
				...
				<td>
					<input style= "width:155px" value="<?=htmlspecialchars($name[1])?>" type="text" class="text" id="last_name" name="last_name" rel="<?=t('Введите, пожалуйста, Ваше полное имя')?>" />
				</td>
			</tr>
			<tr>
				<td class="aright"><b><?=t('Имя')?></b></td>
				<td >
					<input style= "width:155px" value="<?=htmlspecialchars($name[0])?>" type="text" class="text" id="first_name" name="first_name" rel="<?=t('Введите, пожалуйста, Ваше полное имя')?>" />
				</td>
			</tr>
                        <tr>
                        ...
                        <tr id="region_row">
                                ...
                                <td>
                                        ...
                                        <? $regions['']='&mdash;'; ?>
                                        <?=tag_helper::select('region',$regions , array('use_values' => false, 'style' => "width:160px", 'value' => $region_id, 'id'=>'region', 'name'=>'region', 'rel'=>t('Выберите регион'))); ?>
                                </td>
                        </tr>
                        <tr>
                                ...
                                <td>
                                        ...
                                        <? $cities['']='&mdash;'; ?>
                                        <?=tag_helper::select('city', $cities , array('use_values' => false, 'value' => $user_data['city_id'], 'style' => "width:160px", 'id'=>'city', 'name'=>'city', 'rel'=>t('Выберите город/район'))); ?>
                                        ...
                                        <!--input name="city" class="text" type="text" value="<?=$city['name_' . translate::get_lang()]?>" /-->
												...
												<tr>
													...
													<td>
														<input style= "width:155px" value="<?=htmlspecialchars($email)?>" type="text" class="text" id="email" name="email" rel="required:<?=t('Введите, пожалуйста')?>, email;email:<?=t('Вы ввели неправильный')?> email;" />
													</td>
												</tr>
												<tr>
													<td class="aright"><b><?=t("Телефон")?> *</b></td>
													<td>
														<input style= "width:155px" value="<?=htmlspecialchars($phone)?>" type="text" class="text" id="phone" name="phone" rel="required:<?=t('Введите, пожалуйста')?>, <?=t("телефон")?>;" />
													</td>
												</tr>
												<tr>
                        ...
                        <td>
                                        <input <?=$_SESSION['language']!='ru' ? 'checked' : ''?> id="lang_ua" type="radio" name="language" value="ua"/>
                                        <label for="language_ua"><?=t('Украинский')?></label>

                                        <input <?=$_SESSION['language']=='ru' ? 'checked' : ''?> id="lang_ru" type="radio" name="language" value="ru"/>
			...
			<tr>
				<td></td>
				<td>
					<div class="mt10 mb10 fs11 quiet">* <?=t('Ваши телефон и e-mail будут храниться конфиденциально')?></div>

					<input type="submit" name="submit" class="button bold" value="&nbsp; &nbsp;<?=t('Зарегистрироваться')?>&nbsp; &nbsp;" style="width:140px" />
...
<div class="left" style="width: 40%;">
        <p>
            <?=t('Социальная сеть "Меритократ" объединяет людей, которые поддерживают <a href="http://ru.m-p-u.org/meritokratia">идеи меритократии</a> и стремятся создать меритократическое общество в Украине и в мире')?></a>.
        </p>
<!--        <p>
            <?=t('')?>
        </p>-->
