...
class events_mine_action extends events_controller
{
	public function execute()
	{
            $per_page=15; 
            $this->set_template('index');
            $events = events_peer::instance()->get_list(request::get_int('page'), $per_page, false,
                                request::get_int('section'), request::get_int('type'), request::get_int('cat'), session::get_user_id(),true,request::get_int('region'),request::get_int('level'));
