...
class ppo_applicants_peer extends db_peer_postgre
{
	protected $table_name = 'ppo_applicants';
	protected $primary_key = null;

	/**
	 * @return ppo_applicants_peer
	 */
	public static function instance()
	{
		return parent::instance( 'ppo_applicants_peer' );
	}
