...
class ppo_links_dirs_peer extends db_peer_postgre
{
	protected $table_name = 'ppo_links_dirs';
	...
	{
		return parent::instance( 'ppo_links_dirs_peer' );
	}
	...
	{
		$sql = 'SELECT id FROM ' . ppo_links_peer::instance()->get_table_name() .
				' WHERE dir_id = :dir_id ' .
