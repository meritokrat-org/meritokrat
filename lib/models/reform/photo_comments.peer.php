...
class reform_photo_comments_peer extends db_peer_postgre
{
	protected $table_name = 'reform_photo_comments';

	/**
	 * @return reform_photo_comments_peer
	 */
	public static function instance()
	{
		return parent::instance('reform_photo_comments_peer');
	}
