...
class reform_files_peer extends db_peer_postgre
{
	protected $table_name = 'reform_files';
	...
	/**
	 * @return reform_files_peer
	 */
	public static function instance()
	{
		return parent::instance('reform_files_peer');
	}

	public function get_by_group($id, $album_id = null, $order = 'position ASC')
	{
		...
		return $this->get_list($where, array(), array($order));
	}
