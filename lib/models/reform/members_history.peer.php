...
class reform_members_history_peer extends db_peer_postgre
{
	protected $table_name = 'reform_members_history';
	protected $primary_key = null;

	public static function instance()
	{
		return parent::instance('reform_members_history_peer');
	}
