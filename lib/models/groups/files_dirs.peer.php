...
class groups_files_dirs_peer extends db_peer_postgre
{
	protected $table_name = 'groups_files_dirs';

	/**
	 * @return groups_files_dirs_peer
	 */
	public static function instance()
	{
		return parent::instance( 'groups_files_dirs_peer' );
	}
