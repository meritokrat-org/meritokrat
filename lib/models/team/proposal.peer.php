...
class team_proposal_peer extends db_peer_postgre
{
	protected $table_name = 'team_proposal';
	...
	{
		return parent::instance( 'team_proposal_peer' );
	}
	...
	{
		db::exec('DELETE FROM ' . team_proposal_messages_peer::instance()->get_table_name() . ' WHERE topic_id = :id', array('id' => $id));
