...
class team_topics_peer extends db_peer_postgre
{
	protected $table_name = 'team_topics';
	...
	{
		return parent::instance( 'team_topics_peer' );
	}
	...
	{
		db::exec('DELETE FROM ' . team_topics_messages_peer::instance()->get_table_name() . ' WHERE topic_id = :id', array('id' => $id));
