...
class team_photo_comments_peer extends db_peer_postgre
{
	protected $table_name = 'team_photo_comments';

	/**
	 * @return team_photo_comments_peer
	 */
	public static function instance()
	{
		return parent::instance( 'team_photo_comments_peer' );
	}
	...
	{
		return db_key::i()->exists('team_photo_comment_rate:' . $comment_id . ':' . $user_id);
	}

	public function rate( $comment_id, $user_id )
	{
		db_key::i()->set('team_photo_comment_rate:' . $comment_id . ':' . $user_id, true);
	}
