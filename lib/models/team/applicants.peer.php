...
class team_applicants_peer extends db_peer_postgre
{
	protected $table_name = 'team_applicants';
	protected $primary_key = null;

	/**
	 * @return team_applicants_peer
	 */
	public static function instance()
	{
		return parent::instance( 'team_applicants_peer' );
	}
