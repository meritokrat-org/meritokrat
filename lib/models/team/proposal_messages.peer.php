...
class team_proposal_messages_peer extends db_peer_postgre
{
	protected $table_name = 'team_proposal_messages';
	...
	{
		return parent::instance( 'team_proposal_messages_peer' );
	}
