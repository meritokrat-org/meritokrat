...
class team_photos_albums_peer extends db_peer_postgre
{
	protected $table_name = 'team_photos_albums';
	...
	{
		return parent::instance( 'team_photos_albums_peer' );
	}
	...
	{
		$sql = 'SELECT id FROM ' . team_photos_peer::instance()->get_table_name() .
