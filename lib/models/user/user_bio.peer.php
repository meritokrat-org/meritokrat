<?
class user_bio_peer extends db_peer_postgre
{
	protected $table_name = 'user_bio';
	protected $primary_key = 'user_id';
        protected $lang_cols=array("birth_family","major_education",
            "work","society","politika","science","additional_education","progress","other");
	/**
	...
	public static function instance()
	{
		...
		return parent::instance( 'user_bio_peer' );
	}
/*
