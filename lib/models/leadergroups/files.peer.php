...
class leadergroups_files_peer extends db_peer_postgre
{
	protected $table_name = 'leadergroups_files';
	...
	/**
	 * @return leadergroups_files_peer
	 */
	public static function instance()
	{
		return parent::instance( 'leadergroups_files_peer' );
	}
