...
class groups_positions_peer extends db_peer_postgre
{
	protected $table_name = 'groups_position';
	...
	{
		return parent::instance( 'groups_positions_peer' );
	}
	...
	{
		db::exec('DELETE FROM ' . groups_positions_messages_peer::instance()->get_table_name() . ' WHERE topic_id = :id', array('id' => $id));
