...
class groups_proposal_messages_peer extends db_peer_postgre
{
	protected $table_name = 'groups_proposal_messages';
	...
	{
		return parent::instance( 'groups_proposal_messages_peer' );
	}
